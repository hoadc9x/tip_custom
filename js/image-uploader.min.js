    ...
    let o = function () {
      ...
      l = function (t, i, o) {
        ...
        return (
          ...
          r.on("click", function (t) {
            ...
            l.remove(),
              o.children('.uploaded-image').length || o.parent().removeClass("has-files") && o.empty();
          }),
          l
        );
      },
      ...
      g = function (e) {
        return (
          ...
          (alert(
            `Tệp "${
              e.name
            }" không thuộc các định dạng cho phép: "${a.settings.extensions.join(
              '", "'
            )}"`
          ),
          !1)
      ...
      m = function (e, t) {
        return (
          ...
          (alert(
            `Không thể thêm "${t.name}" vì đã tải lên đủ ${a.settings.maxFiles} tệp`
          ),
          !1)
        );
      },
